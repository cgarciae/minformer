...
class Layer:
  def __init__(self, cfg: Config, rngs: nnx.Rngs):
    ...
    self.gamma1 = nnx.Param(jnp.ones(shape.gamma1.shape, dtype=cfg.weight_dtype))
    self.gamma2 = nnx.Param(jnp.ones(shape.gamma2.shape, dtype=cfg.weight_dtype))
